...
D1 engineering side: update .env.example to document the full production env matrix from §D1 — every var, one-line purpose, explicit "leave unset in local" guidance for INNGEST_EVENT_KEY and POSTMARK_SERVER_TOKEN.
