 ...
 *
 * Design language: warm cream / terracotta — matches get-started-stepper.tsx.
 */
...
// ---------------------------------------------------------------------------
// Design tokens — match get-started-stepper.tsx
// ---------------------------------------------------------------------------
          ...
          <form action={updateDigestPrefs} className="space-y-6">
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className={`mt-0.5 text-sm ${labelMuted}`}>
              ...
              <input
                ...
                value="on"
                className="size-5 cursor-pointer rounded-none accent-[#1E6B4F]"
              />
            </div>
