...
export const cardClass =
  "rounded-[6px] border border-[#DEDED8] bg-[#FAFAF8] p-5 shadow-[0_24px_70px_rgba(20,20,15,0.07)] sm:p-6";
...
export const inputClass =
  "h-12 w-full rounded-[4px] border border-[#DEDED8] bg-[#FAFAF8] px-4 text-[15px] font-medium text-[#14140F] outline-none transition-shadow placeholder:text-[#6F6F66] focus:border-[#14140F] focus:shadow-[0_0_0_1px_#14140F]";
...
export const primaryButtonClass =
  "h-14 rounded-[4px] border border-[rgba(30,107,79,0.32)] bg-[#C1F5DF] px-6 text-base font-semibold text-[#14140F] shadow-[inset_0_1px_0_rgba(255,255,255,0.75),inset_0_-2px_0_rgba(30,107,79,0.28),0_12px_24px_rgba(30,107,79,0.16)] transition-colors hover:bg-[#AFF0D3] focus-visible:ring-2 focus-visible:ring-[rgba(30,107,79,0.32)] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60";

/**
 * Compact primary button (h-11) used inside connector card rows.
 */
export const compactPrimaryButtonClass =
  "h-11 rounded-[4px] border border-[rgba(30,107,79,0.32)] bg-[#C1F5DF] px-5 text-sm font-semibold text-[#14140F] shadow-[inset_0_1px_0_rgba(255,255,255,0.75),inset_0_-2px_0_rgba(30,107,79,0.28),0_12px_24px_rgba(30,107,79,0.16)] transition-colors hover:bg-[#AFF0D3] focus-visible:ring-2 focus-visible:ring-[rgba(30,107,79,0.32)] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60";

/**
 * Compact secondary button (h-11) used for "Disconnect" connector actions.
 */
export const secondaryButtonClass =
  "h-11 rounded-[4px] border border-[#DEDED8] bg-[#FAFAF8] px-5 text-sm font-semibold text-[#6F6F66] transition-colors hover:border-[#14140F] hover:text-[#14140F] focus-visible:ring-2 focus-visible:ring-[#14140F]/20 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60";
...
export const sectionDividerClass = "border-t border-[#DEDED8]";
